// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 1
// ============================================
    ...
    from(table) {
        return {
            ...
            insert: async function(data) {
                return await supabase.query(table, { method: 'POST', body: JSON.stringify(data) });
            }
        };
    },
...
// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 2
// ============================================
...
// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 3
// ============================================
...
// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 4
// ============================================
...
// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 5
// ============================================
...
function autoConvertUrlToEmbed(url) {
    ...
    if (url.includes('reddit.com')) {
        return `<blockquote class="reddit-embed" cite="${url}"><a href="${url}">Reddit Video</a></blockquote><script async src="https://embed.reddit.com/widgets.js"></script>`;
    }
...
// ============================================
// TrendyReels - V3.6.1 (LOCKED VERSION) - PART 6
// ============================================
...
async function init() {
    ...
    console.log('TrendyReels V3.6.1 (LOCKED VERSION) initialized!');
}
...
// ============================================
// TrendyReels - V3.7.0 (NEW RSS SYSTEM) - PART 7
// ============================================

// 🆕 PART 7: PENDING VIDEOS (RSS DRAFT SYSTEM)
// ============================================

// Load pending videos (published = false)
...
// Override loadVideos to also load pending videos
...
// Add pending tab to admin navigation
document.addEventListener('DOMContentLoaded', () => {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            // Load pending videos when Pending tab is clicked
            if (tabId === 'pending') {
                loadPendingVideos();
            }
        });
