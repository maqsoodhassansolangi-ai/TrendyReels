...
function buildThumbMediaHtml(video, widthCss, heightCss, extraStyle = '') {
    ...
    if (isNativeVideo) {
        ...
        const videoSrc = srcMatch ? srcMatch[1] : '';
        if (videoSrc) {
            return `<video src="${videoSrc}" style="width:${widthCss}; height:${heightCss}; object-fit:cover; border-radius:4px; background:#000; ${extraStyle}" muted preload="metadata" playsinline></video>`;
        }
    }
